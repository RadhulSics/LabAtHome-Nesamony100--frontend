  ...
  return (
    ...
    <div className="footer-wrapper rjr_flex">
      <div className="footer-info-wrapper">
        ...
        <p className='rjr_p'>Lab At Home provides progressive, and affordable healthcare, accessible on mobile and online 
          for everyone</p>
        <div className="copy-rights">
        <p className='rjr_p'>Lab At Home PTY LTD 2024. All rights reserved</p>
        </div>
      </div>
